...
import { FileText, Upload, Sparkles, Clock, Users } from 'lucide-react';
  ...
  const examples = [
    {
      ...
      content: "Had a call with Sarah Johnson, Marketing Director at GrowthTech. They need marketing automation for 50-person team. Budget: $30K annually. Evaluating HubSpot vs our solution. Next: Demo scheduled for Friday. Sarah has decision-making authority. Company is growing fast, currently using manual processes."
    },
    {
      title: "Enterprise Demo",
      content: "Presented to TechCorp leadership team: Mike Chen (CTO), Lisa Rodriguez (VP Engineering), and David Kim (Director of IT). 200+ person engineering team. Looking for DevOps automation platform. Budget approved for $150K. Main competitors: GitLab, Azure DevOps. Timeline: Implementation by Q2. Next step: Technical deep-dive session next Tuesday."
    },
    {
