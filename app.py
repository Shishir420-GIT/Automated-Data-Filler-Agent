...
# Gradio UI: take summary, show processed schema
with gr.Blocks() as demo:
    summary_input = gr.Textbox(lines=8, placeholder="Paste meeting summary...", label="Meeting Summary")
    process_btn = gr.Button("Process")
    result_out = gr.JSON(label="Processed Data")

    process_btn.click(fn=run_agent, inputs=summary_input, outputs=result_out)
